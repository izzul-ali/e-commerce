    ...
    >
      <div>
        <button
          disabled
          aria-label="trending"
          className="p-3 bg-violet-400/50 rounded-lg flex justify-center items-center"
        >
      ...
      <div>
        <button
          disabled
          aria-label="health"
          className="p-3 bg-orange-400/30 rounded-lg flex justify-center items-center"
        >
      ...
      <div>
        <button
          ...
          className="p-3 bg-sky-400/30 rounded-lg flex justify-center items-center"
        >
      ...
      <div>
        <button
          disabled
          aria-label="fashion"
          className="p-3 bg-lime-400/30 rounded-lg flex justify-center items-center"
        >
